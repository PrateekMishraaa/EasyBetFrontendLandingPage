// components/LoginForm.jsx - Fixed Login Form with proper functionality
...
const LoginForm = ({ onClose, onRegisterClick }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('login form response', response.data);
        ...
        <div className="bg-[#0B0E1A] rounded-2xl border border-gray-800 w-full max-w-md max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="sticky top-0 bg-[#0B0E1A] border-b border-gray-800 px-6 py-4 flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-400 text-xs mt-1">Login to your Easybet account</p>
            </div>
            <button 
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit}>
            <div className="p-6 space-y-5">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-300 text-sm font-medium mb-1.5">Email or Username *</label>
                  <input
                    type="text"
                    name="UserName"
              ...
              <div className="text-right">
                <button type="button" className="text-[#00E5FF] text-xs hover:underline">
                  Forgot Password?
                </button>
              </div>
